...
public class RemoteDriverFireFoxProvider extends AbstractDriverFactory{
    @Override
    public WebDriver getDriver() {
        ...
        try {
            return new RemoteWebDriver(new URL(ConfigLoader.getInstance().getValue(Constants.GRID_URL)), options);
